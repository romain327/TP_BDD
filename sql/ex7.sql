...
SELECT utilisateur.id_etudiant, nom_etudiant, prenom_etudiant, COUNT(reservation.id_etudiant) as nb_reservation FROM utilisateur INNER JOIN reservation USING(id_etudiant) GROUP BY utilisateur.id_etudiant;
